    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="./usuariosEdit.php?id=<?php echo $linha["id"];?>" class="btn btn-warning">Editar</a>
                    <a href="./usuariosDelete.php?id=<?php echo $linha["id"];?>" class="btn btn-danger">Excluir</a>
                </td>
            </tr>
        <?php
        }
